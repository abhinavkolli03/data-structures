public class BinarySearchTree <T extends Comparable<T>> {
    ...
    private Node remove(Node node, T elem) {
        ...
        //dig into left subtree, if the value
        //we're looking for is smaller than the current value
        if(cmp < 0) {
            ...
            //subtree at all. In this situation just swap the node we wish
    ...
    //This method returns an iterator for a given TreeTraversal Order.
